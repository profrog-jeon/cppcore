...
namespace core
{
	...
	size_t		EncodeData(const ST_SYM_CIPHER_KEY& stCipherKey, LPCBYTE pSrc, size_t tSrcSize, LPBYTE pDest = NULL);
	size_t		DecodeData(const ST_SYM_CIPHER_KEY& stCipherKey, LPCBYTE pSrc, size_t tSrcSize, LPBYTE pDest = NULL);
}
