...
{
	//////////////////////////////////////////////////////////////////////////
	CUTF8StringReader::CUTF8StringReader(LPCBYTE pContext, size_t tSize)
		: IChannel()
		, m_tReadPos(0)
		, m_strContext()
	{
	...
	//////////////////////////////////////////////////////////////////////////
	CUTF8StringReader::CUTF8StringReader(const char* pszContext)
		: IChannel()
		, m_tReadPos(0)
		, m_strContext()
	{
		m_strContext = TCSFromUTF8(pszContext);
	}

	//////////////////////////////////////////////////////////////////////////
	CUTF8StringReader::CUTF8StringReader(std::string& strContext)
		: IChannel()
		, m_tReadPos(0)
		, m_strContext()
	{
		m_strContext = TCSFromUTF8(strContext);
	}

	//////////////////////////////////////////////////////////////////////////
	CUTF8StringReader::~CUTF8StringReader(void)
	{
	}

	//////////////////////////////////////////////////////////////////////////
	bool CUTF8StringReader::CheckValidity(std::tstring& refStrErrMsg)
	{
		return true;
	}
