...
{
	class CKeyArraySerializer : public core::IFormatterT
	{
	private:
	...
	public:
		CKeyArraySerializer(core::IChannel& channel, std::tstring strSeperator, std::tstring strQuotator);
		~CKeyArraySerializer(void);
