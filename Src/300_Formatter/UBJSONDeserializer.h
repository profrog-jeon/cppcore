...
{
	class CUBJSONDeserializerA : public core::CFormatterSuperA
	{
	public:
		enum eGroupingType
		{
	...
	public:
						CUBJSONDeserializerA(core::IChannel& channel);
						CUBJSONDeserializerA(core::IChannel& channel, std::vector<std::string>& vecChunk);
						~CUBJSONDeserializerA(void);
	...
	class CUBJSONDeserializerW : public core::CFormatterSuperW
	{
	public:
		enum eGroupingType
		{
	...
	public:
		CUBJSONDeserializerW(core::IChannel& channel);
		CUBJSONDeserializerW(core::IChannel& channel, std::vector<std::wstring>& vecChunk);
		~CUBJSONDeserializerW(void);
